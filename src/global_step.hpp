...
class GlobalStep
{
 public:
  ...
  void ProxCSLUpdate(double lambda_t = -1.0, double alpha = 0.0, bool adaptive = false);

  void ProxQuadUpdate(double lambda_t = -1.0, double alpha = 0.0, bool adaptive = false);
